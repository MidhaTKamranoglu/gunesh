  ...
  <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box p-l-20 p-r-20">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="/user/update/{{$user->id}}" enctype="multipart/form-data" method="POST" class="form-horizontal">
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <input name="name" value="{{$user->name}}" type="text" class="form-control form-control-line"> </div>
                                        </div> 
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <input name="username" value="{{$user->username}}" type="text" class="form-control form-control-line" value="ad soyad"> </div>
                                        </div> 
                                        <div class="form-group">
                                            <label class="col-md-12" for="example-email">ElektronPoçt <span class="help"> e.g. "example@gmail.com"</span></label>
                                            <div class="col-md-12">
                                                <input value="{{$user->email}}" type="email" id="example-email2" name="email" class="form-control form-control-line" placeholder="Email"> </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input name="mobile" value="{{$user->mobile}}" type="text" class="form-control form-control-line" placeholder="placeholder"> </div>
                                        </div>
                                        <div class="form-group">
